...
C                 detected.
C
      subroutine    helmbrik8v(x, y, z, p, sm, m, outerr)
C
C                   A R G U M E N T S
C
      integer   p, m,outerr
...
C            write(6,*)'  det =  ', det
            do 2000  j = 1,8
C             write(6,'(a,i2,a,f8.5,a,i2,a,f8.5,a,i2,a,f8.5)')
C     &       '  qx(', j,') = ', qx(j), '  qy(', j,') = ', qy(j),'  qz(', j,') = ', qz(j)
C             write(6,'(a,i2,a,f8.5)')'  qx(', j,') = ', qx(j)
C             write(6,'(a,i2,a,f8.5)')'  qy(', j,') = ', qy(j)
C             write(6,'(a,i2,a,f8.5)')'  qz(', j,') = ', qz(j)
C             write(6,'(a,i2,a,f8.5,a,f8.5,a,f8.5)')'  q(', j,') = ', qx(j), '  ', qy(j), '  ', qz(j)
             cx = qx(j) * w
             cy = qy(j) * w                
             cz = qz(j) * w
              do 1500  i = j,8
