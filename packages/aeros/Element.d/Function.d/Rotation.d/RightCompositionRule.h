#ifndef _RIGHTCOMPOSITIONRULE_H_
#define _RIGHTCOMPOSITIONRULE_H_
...
class RightCompositionRule : public VectorValuedFunction<3,3,Scalar,3,0,double>
{
   Eigen::Matrix<double,3,1> Psi1;
   Eigen::Matrix<double,3,3> R1;

  public:
    RightCompositionRule(const Eigen::Array<double,3,1>& sconst, const Eigen::Array<int,0,1>&)
    {
