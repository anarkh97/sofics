#ifndef _THREEFIELDSTRAINENERGYFUNCTION_H_
#define _THREEFIELDSTRAINENERGYFUNCTION_H_
...
#include <Element.d/Function.d/StrainEnergyDensity.d/CompressibleNeoHookeanStrainEnergyDensityFunction.h>
#include <Element.d/Function.d/StrainEnergyDensity.d/CompressibleMooneyRivlinStrainEnergyDensityFunction.h>
...
class ThreeFieldStrainEnergyFunction
 : public ScalarValuedFunction<ShapeFunctionTemplate<Scalar>::NumberOfGeneralizedCoordinates*ShapeFunctionTemplate<Scalar>::NumberOfValues
                               ...
                               Scalar,
                               ShapeFunctionTemplate<Scalar>::NumberOfGeneralizedCoordinates*ShapeFunctionTemplate<Scalar>::NumberOfValues+3
                               +ShapeFunctionTemplate2<Scalar>::NumberOfValues
                               +ShapeFunctionTemplate3<Scalar>::NumberOfValues,
                               2,
                               double>
{
  public:
    enum {
      ...
      NumberOfScalarConstants = NumberOfGeneralizedCoordinates+MaximumNumberOfMaterialConstants,
  ...
  public:
    ThreeFieldStrainEnergyFunction(const Eigen::Array<double,NumberOfScalarConstants,1>& sconst,
    ...
    Scalar operator() (const Eigen::Matrix<Scalar,NumberOfGeneralizedCoordinates,1>& q, Scalar t)
    {
      ...
      for(int ip = 0; ip < qrule.getN(); ++ip) {
        ...
        // evaluate the strain energy density function at the integration point
        V += (abs(J.determinant())*weight)*((*W)(Fbar) + p_G*(j-Theta_G));
      }
