...
PointVariPlaneSegmentDistanceConstraintElement::PointVariPlaneSegmentDistanceConstraintElement(int* _nn)
 : ConstraintFunctionElement<Simo::PointVariPlaneSegmentDistanceConstraintFunction>(4, DofSet::XYZdisp, _nn, 0)
{
}

void
PointVariPlaneSegmentDistanceConstraintElement::getConstants(const CoordSet & cs,
