...
PointVariPlaneSegmentDistanceConstraintElement2::PointVariPlaneSegmentDistanceConstraintElement2(int* _nn)
 : ConstraintFunctionElement<Simo::PointVariPlaneSegmentDistanceConstraintFunction2>(4, DofSet::XYZdisp, _nn, 0)
{
}
