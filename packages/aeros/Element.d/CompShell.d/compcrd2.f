...
C=====================================================================C
      subroutine compcrd2( elm  , type , X   , Y    , Z    , rot  ,
...
C
      side21length = dsqrt(x21*x21 + y21*y21 + z21*z21)
C
...
C
      side32length = dsqrt(x32*x32 + y32*y32 + z32*z32)
C
...
C
      area = 0.50D+00*side21length*dsqrt(signedarea)
C
...
C
      lengthZ = dsqrt(zp(1)*zp(1) + zp(2)*zp(2) + zp(3)*zp(3))
C
...
C
      lengthY = dsqrt(yp(1)*yp(1) + yp(2)*yp(2) + yp(3)*yp(3))
C
