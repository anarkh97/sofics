...
//                                            CONSTRUCTOR METHODS
// -----------------------------------------------------------------------------------------------------
StdMortarQuad9::StdMortarQuad9() {} 
// call the default base class constructor MortarElement::MortarElement() 

StdMortarQuad9::StdMortarQuad9(FaceElement* FaceElem)
{
  SetPtrMasterFace(FaceElem);
}

StdMortarQuad9::StdMortarQuad9(double area_, FaceElement* FaceElem)
{
  SetArea(area_);
  SetPtrMasterFace(FaceElem);
}
...
// -----------------------------------------------------------------------------------------------------
int
StdMortarQuad9::nNodes() { return 9; }

int
StdMortarQuad9::nMortarShapeFct() { return 9; }
...
template<>
void
StdMortarQuad9::GetShapeFctVal(double* Shape, double* m)
{
...
template<>
void
StdMortarQuad9::GetdShapeFct(double* dShapex, double* dShapey, double* m)
{
...
template<>
void
StdMortarQuad9::Getd2ShapeFct(double* d2Shapex, double* d2Shapey, double* d2Shapexy, double* m)
{
