...
#ifndef ContactTDAreaWeld_h_
#define ContactTDAreaWeld_h_

#include "ContactTDEnfModel.h"
#include "ContactSearch.h"
#include "contact_assert.h"

class ContactTDAreaWeld : public ContactTDEnfModel {

 public:
  ContactTDAreaWeld( int ID, int* int_data, Real* real_data, 
		      ContactTopology* topology );
  ContactTDAreaWeld(ContactTopology* topology);
  ~ContactTDAreaWeld();
