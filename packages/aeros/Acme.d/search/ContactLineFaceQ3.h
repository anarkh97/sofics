...
#ifndef ContactLineFaceQ3_h_
#define ContactLineFaceQ3_h_
...
class ContactLineFaceQ3 : public ContactFace<Real> {
 ...
 public:
  ...
  static ContactLineFaceQ3* new_ContactLineFaceQ3(ContactFixedSizeAllocator*,
                                                  int blk_indx=-1, 
                                                  int indx_in_block=-1, 
                                                  int key=-1);
  ~ContactLineFaceQ3();
