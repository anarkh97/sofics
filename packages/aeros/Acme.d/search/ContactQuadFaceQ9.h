...
#ifndef ContactQuadFaceQ9_h_
#define ContactQuadFaceQ9_h_
...
class ContactQuadFaceQ9 : public ContactFace<Real> {
 ...
 public:
  ...
  static ContactQuadFaceQ9* new_ContactQuadFaceQ9(ContactFixedSizeAllocator*,
                                                  int blk_indx=-1, 
                                                  int indx_in_block=-1, int key=-1);
  ~ContactQuadFaceQ9();
  ...
  static void Compute_Global_Coords( Real node_positions[9][3],
				     Real local_coords[2],
				     Real global_coords[3] );
...
#endif // ifdef ContactQuadFaceQ9_h_
