      SUBROUTINE FPSLAPIV( DIREC, ROWCOL, PIVROC, M, N, A, IA, JA,
...
*     .. External Subroutines ..
     ...
     $                   INFOG2L, PICOL2ROW, PIROW2COL, FPSLAPV2
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
         IF( LSAME( PIVROC, 'C' ) ) THEN
            CALL FPSLAPV2( DIREC, ROWCOL, M, N, A, IA, JA, DESCA, IPIV,
     $                    IP, JP, DESCIP )
*
*        Otherwise, we must redistribute IPIV to match FPSLAPV2
*
         ELSE
*
...
*
   ...
   10       CONTINUE
            CALL FPSLAPV2( DIREC, ROWCOL, M, N, A, IA, JA, DESCA, IWORK,
     $                    IPT, 1, DESCPT )
         END IF
*
