      SUBROUTINE FPDLAPIV( DIREC, ROWCOL, PIVROC, M, N, A, IA, JA,
...
*     .. External Subroutines ..
     ...
     $                   INFOG2L, FPDLAPV2, PICOL2ROW, PIROW2COL
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
         IF( LSAME( PIVROC, 'C' ) ) THEN
            CALL FPDLAPV2( DIREC, ROWCOL, M, N, A, IA, JA, DESCA, IPIV,
     $                    IP, JP, DESCIP )
*
*        Otherwise, we must redistribute IPIV to match FPDLAPV2
*
         ELSE
*
...
*
   ...
   10       CONTINUE
            CALL FPDLAPV2( DIREC, ROWCOL, M, N, A, IA, JA, DESCA, IWORK,
     $                    IPT, 1, DESCPT )
         END IF
*
