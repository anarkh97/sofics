...
************************************************************************
************************************************************************
*****  ZBLKSLV ... block triangular solutions (complex)            *****
************************************************************************
************************************************************************
*
*   --------
...
*
*     SOLN      (output) COMPLEX*16 array, dimension N
*               The solution vector.
*
*     TEMP      (temporary) COMPLEX*16 array, dimension N
*               Temporary work array.
*
************************************************************************
*
      SUBROUTINE  ZBLKSLV  ( NPANEL, XPANEL, XLINDX, LINDX , XLNZ  ,
