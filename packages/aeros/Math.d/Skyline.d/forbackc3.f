...
C=PURPOSE FORWARD and BACKWARD are serial and unrolled to level 3  -
C=AUTHOR  M. LESOINNE A. PUPPIN-MACEDO
C=AUTHOR  March 1998 
C=BLOCK 
      subroutine FORBACKC3(COLVAL,LD,W1,W2,W3,PIVOT,NEQ)
C----------------------------------------------------------------------------
C     FORBACKC3 = forward/backward substitution of a symmetric skyline 
C                matrix  using variable band information
C                with unrolling depth = 3 
C
