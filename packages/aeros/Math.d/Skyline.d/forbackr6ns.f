...
C=AUTHOR  June 1998
C=BLOCK
      subroutine FORBACKR6NS(COLVAL,LD,W1,W2,W3,W4,W5,W6,NEQ)
C----------------------------------------------------------------------------
C     FORBACKR6NS = forward/backward substitution of a symmetric skyline
...
C
      INTEGER LD(*),NEQ
      REAL*8  COLVAL(*),W1(*),W2(*),W3(*),W4(*),W5(*),W6(*),XTEMP
C
C-----Local DECLARATIONS
C
      INTEGER K,J,I,IW,LEN
C
...
C
      DO 500 J = 2, NEQ
         LEN  = LD(J) - LD(J - 1) - 1
C  Break the dependency check between W1,W2,W3,W4,W5,W6
CDIR$ IVDEP
         DO K = 1, LEN
