...
C=AUTHOR  June 1998
C=BLOCK
      subroutine FORBACKR4NS(COLVAL,LD,W1,W2,W3,W4,NEQ)
C----------------------------------------------------------------------------
C     FORBACKR4NS = forward/backward substitution of a symmetric skyline
...
C
      INTEGER LD(*),NEQ
      REAL*8  COLVAL(*),W1(*),W2(*),W3(*),W4(*),XTEMP
C
