...
C=AUTHOR  June 1998
C=BLOCK
      subroutine FORBACKR5NS(COLVAL,LD,W1,W2,W3,W4,W5,NEQ)
C----------------------------------------------------------------------------
C     FORBACKR5 = forward/backward substitution of a symmetric skyline
...
C
      INTEGER LD(*),NEQ
      REAL*8  COLVAL(*),W1(*),W2(*),W3(*),W4(*),W5(*),XTEMP
C
...
C
      DO 500 J = 2, NEQ
         LEN  = LD(J) - LD(J - 1) - 1
C  Break the dependency check between W1,W2,W3,W4,W5
CDIR$ IVDEP
         DO K = 1, LEN
