...
************************************************************************
************************************************************************
*****  BLKSLVP ... block triangular solutions (real)               *****
************************************************************************
************************************************************************
*
*   --------
...
*
*     T         (temporary) DOUBLE PRECISION array, dimension N
*               Temporary work arrays.
*
************************************************************************
*
      SUBROUTINE  BLKSLVP ( NPANEL, XPANEL, XLINDX, LINDX , XLNZ  ,
...
*       -------------------
        ...
        DOUBLE PRECISION    S(LDR,*)
        DOUBLE PRECISION    T(LDR,*)
*
************************************************************************
*
*       --------------
...
*
            CALL  DGEMM ('NO TRANSPOSE', 'NO TRANSPOSE', JLEN-NJ,
...
*
        IF  ( DEFBLK .NE. 0 )  THEN
            ...
            JLEN  = XLNZ(FJ+1) - XLNZ(FJ)
            JLPNT = XLNZ(FJ)
            CALL  DGERS ( NJ, NRHS, LNZ(JLPNT), JLEN, LBDEF,
...
*
            IF  ( JLEN .GT. NJ )  THEN
*
            CALL  DGEMM ('TRANSPOSE', 'NO TRANSPOSE', NJ,
